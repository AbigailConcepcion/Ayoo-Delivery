...
const getVariantClasses = (variant?: string) => {
  switch (variant) {
    ...
    case 'colored':
      return 'bg-gradient-to-br from-primaryDark via-primary to-primaryLight';
    default:
...
export const Logo: React.FC<LogoProps> = ({
  ...
  if (variant === 'icon') {
    return (
    <div className={`${sizeConfig.container} rounded-[30px] bg-gradient-to-br from-primaryDark via-primary to-primaryLight flex items-center justify-center shadow-xl overflow-hidden`}>
        <img
          src={AYOO_IMAGE_URL}
          alt="Ayoo Icon"
