...
const BASE_SERVICES: ServiceCard[] = [
  {
    ...
    gradient: 'from-[#C084FC] to-[#A78BFA]',
    speedRank: 2,
    valueRank: 2,
    defaultRank: 1
  },
...
const Services: React.FC<ServicesProps> = ({ user, deliveryCity, onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F3E8FF] flex flex-col pb-24 overflow-y-auto scrollbar-hide">
      <header className="bg-gradient-to-br from-[#C084FC] via-[#A855F7] to-[#8B5CF6] text-white px-5 pt-5 pb-7 rounded-b-[30px] shadow-xl sticky top-0 z-20">
        <div className="flex items-center justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="w-12 h-12 rounded-2xl bg-white text-[#C084FC] flex items-center justify-center shadow-lg"
            title="Account"
          >
            ⚙️
          </button>
      ...
      <main className="p-5 space-y-6">
        <section className="bg-white rounded-[24px] border border-gray-100 p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-purple-500">One-tap personalization</span>
          </div>
            ...
            {([
              ...
              { key: 'VALUE', label: 'Best Value' }
                ...
                <button
                  ...
                  className={`py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest ${priority === lane.key ? 'bg-purple-500 text-white' : 'bg-gray-100 text-gray-500'
                    }`}
                >
                {lane.label}
              </button>
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-purple-500">Distance-aware ETA</span>
          </div>
          <div className="grid grid-cols-2 gap-3">
            {services.map((service) => (
              ...
              >
                ...
                <p className="text-[10px] font-black uppercase tracking-widest text-purple-500 mt-2">{service.etaHint}</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            {quickActions.map((item) => (
              <button
                ...
                className="bg-purple-50 border border-purple-200/50 rounded-2xl p-3 text-left"
              >
